...
if __name__ == "__main__":
    ...
    t1=time.time()
    cost=ga.geneticAlgorithm(cityList, popSize=int(params["popSize"]),eliteSize = int(params["eliteSize"]), mutationRate=int(params["mutationRate"]),generations = int(params["population"]))
    t2=time.time()
